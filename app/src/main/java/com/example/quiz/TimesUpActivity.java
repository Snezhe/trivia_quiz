...
public class TimesUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.times_up);
        scoreTitle = findViewById(R.id.score);
        playAgain = findViewById(R.id.try_again_button);
